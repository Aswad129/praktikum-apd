...
total_gaji = ((bayaran_perjam * jam_kerja) * hari_kerja) + (jumlah_lembur * bayaran_perlemburan)
...
print("Jabatan                 : ", jabatan_karyawan)
...
print(f"Bayaran per lemburan    : Rp {bayaran_perlemburan:,.0f}")
print("-" * 50)
